...
function FaceRecognitionView({ ...props }: Props) {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen p-4 text-white bg-[#ed1b24]">
      <h1 className="text-2xl font-bold mb-4">Face Check-in</h1>

      {/* Step Instructions */}
      <div className="mb-6 text-center">
        <p className="text-lg font-semibold mb-1">
          Step 1: Align your face in the camera frame
        </p>
        <p className="text-sm">
      ...
      {/* Face Status */}
      <div className="mt-4 text-sm italic text-green-400">
        {props.faceStatus}
      </div>
    </div>
  );
